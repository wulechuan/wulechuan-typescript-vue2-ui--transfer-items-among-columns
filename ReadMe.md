...
设有任一两个当采用【`单列`】部件以自行拼装功能模块时，难免要编写这样的工具函数（不妨暂称【甲】）：【甲】接受两个【`单列`】（暂称【起】、【迄】两列）的旧有【条目】列表，并将【起】列中凡已【被选中故而凸显】之【条目】转移到【迄】列中。得到两个新的【条目】列表。又，【甲】返回这两个新的【条目】列表，供【起】、【迄】两列采用。

又，【甲】不应为【`单列`】的方法函数。换言之，【甲】既不属于【起】，也不属于【迄】。
