...
export default class Wlc双列互换数据 extends Vue {
    ...
    private 将某列选中的条目迁移至对方列 (起列之数据集?: 范_单列之内部数据集): void {
        ...
        const 起列之所有条目之列表的旧模样: 范_内用格式之条目之列表 = 起列之数据集.所有条目之列表
        const 迄列之所有条目之列表的旧模样: 范_内用格式之条目之列表 = 迄列之数据集.所有条目之列表

        const 起列之所有条目之列表拟变成的新模样: 范_内用格式之条目之列表 = []
        const 迄列之所有条目之列表拟变成的新模样: 范_内用格式之条目之列表 = [
            ...迄列之所有条目之列表的旧模样,
        ]
