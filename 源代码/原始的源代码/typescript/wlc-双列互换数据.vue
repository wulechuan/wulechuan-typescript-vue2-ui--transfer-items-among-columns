<template>
    <div class="吴乐川-双列互换数据">
        <header class="总标题栏">
            <slot name="内容皿-总标题栏" v-bind="用于各界面内容皿之状态集"></slot>
        </header>
        ...
        <div class="容纳着双列的中央主体">
            ...
            <div class="甲乙两列之间之竖栏">
                ...
                <slot name="内容皿-中央列" v-bind="用于各界面内容皿之状态集">
                    <div class="甲乙两列之间之竖栏之默认内容">
                        <div class="功能单体 功能单体-主体为按钮">
                            <button
                                ...
                                :disabled="用于各界面内容皿之状态集.甲列当下没有条目拟迁移至乙列"
                                @click="每当点击用以将甲列选中之条目迁移至乙列之按钮后()"
                            >{{ 按钮上的措辞_中央竖栏默认内容_将条目从甲列迁移至乙列_最终采纳值 }}</button>
                            <sup
                                v-if="!用于各界面内容皿之状态集.甲列当下没有条目拟迁移至乙列"
                                class="角标 角标-位置应居左"
                            >{{ 用于各界面内容皿之状态集.甲列当下选中的条目之总数 }}</sup>
                        </div>
                        ...
                        <div class="功能单体 功能单体-主体为按钮">
                            <button
                                ...
                                :disabled="用于各界面内容皿之状态集.乙列当下没有条目拟迁移至甲列"
                                @click="每当点击用以将乙列选中之条目迁移至甲列之按钮后()"
                            >{{ 按钮上的措辞_中央竖栏默认内容_将条目从乙列迁移至甲列_最终采纳值 }}</button>
                            <sup
                                v-if="!用于各界面内容皿之状态集.乙列当下没有条目拟迁移至甲列"
                                class="角标"
                            >{{ 用于各界面内容皿之状态集.乙列当下选中的条目之总数 }}</sup>
                        </div>
                    </div>
                </slot>
        ...
        <footer class="底部内容栏">
            <slot name="内容皿-底部内容栏" v-bind="用于各界面内容皿之状态集">
