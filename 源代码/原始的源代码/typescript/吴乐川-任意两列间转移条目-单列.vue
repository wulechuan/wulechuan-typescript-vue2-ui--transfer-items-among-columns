...
export default class Wlc任意两列间转移条目_单列 extends Vue {
    ...
    private 求_与全部选中或取消选中某些条目有关之三态勾选框之汇总数据 (本次统计时应将暂不可见的条目一并计入?: boolean) {
        ...
        let 交互项之特征样式类名_三态勾选框_其根元素: 范_交互项之三态勾选框_特征样式类名 = null
        let 交互项之特征样式类名_三态勾选框_其勾选项之根元素: 范_交互项之三态勾选框_特征样式类名 = null
        ...
        if (本次统计时应将暂不可见的条目一并计入) {
            if (应禁止三态勾选框之交互) {
                交互项之特征样式类名_三态勾选框_其根元素 = '已禁止交互'
                交互项之特征样式类名_三态勾选框_其勾选项之根元素 = '已禁止交互'
        ...
        if (!应禁止三态勾选框之交互) {
            if (三态勾选框之状态值 === '未勾选') {
                交互项之特征样式类名_三态勾选框_其根元素 = '未勾选'
                交互项之特征样式类名_三态勾选框_其勾选项之根元素 = '未勾选'
            } else if (三态勾选框之状态值 === '已勾选') {
                交互项之特征样式类名_三态勾选框_其根元素 = '已勾选'
                交互项之特征样式类名_三态勾选框_其勾选项之根元素 = '已勾选'
            } else {
                交互项之特征样式类名_三态勾选框_其根元素 = '已部分勾选'
                交互项之特征样式类名_三态勾选框_其勾选项之根元素 = '已部分勾选'
            }
        }

        const 汇总数据 = {
            三态勾选框之配文之措辞: 三态勾选框之配文之措辞!,
            应禁止三态勾选框之交互,
            三态勾选框之状态值,
