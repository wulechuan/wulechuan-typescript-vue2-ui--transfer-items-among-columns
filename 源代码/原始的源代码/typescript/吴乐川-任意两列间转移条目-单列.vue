                ...
                >
                    ...
                    >
                        ...
                        <input
                            ...
                            :disabled="应全面禁止交互 || 与选中所有条目_含隐藏之条目_之交互相关之汇总数据.应禁止三态勾选框之交互"
                ...
                >
                    ...
                    >
                        ...
                        <input
                            ...
                            :disabled="应全面禁止交互 || 与选中所有条目_仅列示之条目_之交互相关之汇总数据.应禁止三态勾选框之交互"
...
export default class Wlc任意两列间转移条目_单列 extends Vue {
    ...
    private get 条目过滤器文本输入框元素之样式类名配置 (): 范_界面元素之样式类名之配置 {
        ...
        const 应给予视觉强调以引导用户来此: boolean = !应禁止条目过滤器交互 && 当下期望列示的条目过多故暂不列示任何条目 && !用以过滤条目之关键词
