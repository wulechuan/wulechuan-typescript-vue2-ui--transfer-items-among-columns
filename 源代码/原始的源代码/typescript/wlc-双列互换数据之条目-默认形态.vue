<template>
    <span v-if="条目" class="吴乐川-双列互换数据之条目 默认形态">{{ 条目.在界面中的称谓 }}</span>
</template>
...
@Component({})
export default class Wlc双列互换数据之条目之默认形态 extends Vue {
...
@import '../stylus/仅尺寸与排版与关键行为（亦可单独发行）/默认/1-主表之条目.styl'
@import '../stylus/仅着色与装饰（亦可单独发行）/默认/1-主表之条目.styl'
</style>
