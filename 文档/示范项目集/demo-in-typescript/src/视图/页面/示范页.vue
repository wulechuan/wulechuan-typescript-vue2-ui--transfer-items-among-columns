    ...
    <div class="页面 页面--示范页">
        <div class="页面中央内容块">
            <Wlc双列互换数据
                ...
                :甲列之特征样式类名之配置="双列互换数据功能.左列之特征样式类名之配置"
                :乙列之特征样式类名之配置="双列互换数据功能.右列之特征样式类名之配置"
                ...
                :按钮上的措辞_中央竖栏默认内容_将条目从甲列迁移至乙列="双列互换数据功能.按钮上的措辞_中央竖栏默认内容_将条目从甲列迁移至乙列"
                :按钮上的措辞_中央竖栏默认内容_将条目从乙列迁移至甲列="双列互换数据功能.按钮上的措辞_中央竖栏默认内容_将条目从乙列迁移至甲列"
                :按钮上的措辞_底部内容栏默认内容_将条目从甲列迁移至乙列="双列互换数据功能.按钮上的措辞_底部内容栏默认内容_将条目从甲列迁移至乙列"
                :按钮上的措辞_底部内容栏默认内容_将条目从乙列迁移至甲列="双列互换数据功能.按钮上的措辞_底部内容栏默认内容_将条目从乙列迁移至甲列"
...
type 范_示范页_双列互换数据功能配置集 = {
    ...
    左列之称谓: string;
    右列之称谓: string;
    左列之特征样式类名之配置?: 范_界面元素之样式类名之配置;
    右列之特征样式类名之配置?: 范_界面元素之样式类名之配置;
...
export default class Page示范页 extends Vue {
    private 双列互换数据功能: 范_示范页_双列互换数据功能配置集 = {
        ...
        左列之称谓: '可以买到的神兽',
        右列之称谓: '准备烤着吃的神兽',
        左列之特征样式类名之配置: { '没买到的': true, '左': false },
        右列之特征样式类名之配置: { '已买到的': true, '右': true },
        单列允许列示的条目数之上限: 16,
        // 各列新增条目之插入规则: '总是追加在首部',
