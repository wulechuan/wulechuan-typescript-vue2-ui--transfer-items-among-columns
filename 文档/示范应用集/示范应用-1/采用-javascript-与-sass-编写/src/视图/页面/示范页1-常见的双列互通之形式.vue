    ...
    <div class="页面 页面--示范页1-常见的双列互通之形式">
        ...
        <div class="页面中央内容块">
            <Wlc任意两列间转移条目_现成实用的双列
                ref="双列间转移条目控件-1"
                v-model="双列间转移条目功能.当下已选购的条目之唯一标识之列表"
                v-bind="双列间转移条目功能.可成批自动绑定的属性"
                :乙列初始选中的条目之唯一标识之列表="双列间转移条目功能.可成批自动绑定的属性.乙列初始选中的条目之唯一标识之列表"
                :应全面禁止交互="应全面禁止交互"
...
export default {
    ...
    methods: {
        初始化数据 () {
            this.双列间转移条目功能.当下已选购的条目之唯一标识之列表 = [ // 即已位于右列的所有条目。
            ...
            this.双列间转移条目功能.可成批自动绑定的属性 = 可成批自动绑定的属性
        },
